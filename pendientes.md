...
## Pendientes antes de lanzar v0.3
...
## Pendientes antes de lanzar v0.4
...
## Pendientes antes de lanzar v0.5
...
* Verifica que cuando el cliente realiza el pedido al admin le está llegando al whatsapp y que cuando le dice pedido xxxx listo, que el bot ya no mande la alerta cada 5 minutos sino que le diga que ya ha sido confirmado 
